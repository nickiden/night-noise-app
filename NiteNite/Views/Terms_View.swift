...
struct Terms_View: View {
    var body: some View {
        ...
        VStack {
            ...
            Text("1. This application is for entertainment purposes only. This is not to replace medical advice.").padding()
            Text("2. All the recordings in the NiteNite app are written, recorded, and produced by use and our affiliates. If you want to use something just ask but don't steal.").padding()
